# 📦 Sistem Inventaris Barang (Warehouse Management System)
...
* **Export PDF:** Cetak laporan bersih otomatis menggunakan CSS `@media print`.
* **Tanda Tangan Digital:** Fitur TTD langsung di layar menggunakan HTML5 Canvas API.

## 🛠️ Tech Stack
* PHP Native, MySQL (phpMyAdmin), JavaScript (Vanilla), HTML5, & CSS3.
